$(function(){
  ...
  function alertaEvento(data) {
	//  console.log('Holy fucking is very easy nodej '+data)
	 //   alert('Holy fucking is very easy nodejs'+data);
  ...
  function seOprimioBoton(e) {
	  
	  alertaEvento(e); 
	  var msj = {msg:'algun mensaje'};
	  socket.emit('OprimioBoton', msj); 
  }
  ...
  socket.on('lanzaFromApp', alertaEvento);
  ...
  $('#btnAgrega').on('click',seOprimioBoton);
